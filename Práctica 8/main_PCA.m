...
for i=1:f
    for j=1:c
        X(i,j) = (X(i,j) - medias(j))/desviacion(j);
    end
end
% ============================================================
...
% ====================== YOUR CODE HERE ======================
[autovectores, autovalores_diag] = eig(C);
autovalores = diag(autovalores_diag);
% ============================================================

% 4. Ordenacion de los autovectores en funcion de sus valores singulares
% asociados de mayor a menor. 
% ====================== YOUR CODE HERE ======================
[autovalores_ordenados, pos] = sort(autovalores, 'descend');
% ============================================================
...
% paso 4)
% ====================== YOUR CODE HERE ======================
posVectoresSeleccionados = pos(1:k);
vectoresSeleccionados = autovectores(:,posVectoresSeleccionados);
% ============================================================
...
% ====================== YOUR CODE HERE ======================
[f,c] = size(X);
DatosPCASol = zeros(f,k);
for i=1:f
    DatosPCASol(i,:) = X(i,:) * vectoresSeleccionados;
end
% ============================================================

function cost_i = fCalculaCosteRegLog(y, y_hat) %calcula el coste pero solo para un elemento, lo que esta dentro del sumatorio (el bucle hace als veces de un sumatorio)

function h = fClasifica_LogisticReg(X_test, theta) %todos los datos de test y los theta
...
% 
    ...
    for i=1:numElemTest %%itera para todos los elementos de test y para cada elemento de h se calcula la salida de la funcion sigmoidal
        x_test_i = [1, X_test(i,:)]; %caracteristicas para cada elemento que le paso a la funcion sigmoidal
        % ====================== YOUR CODE HERE ======================
